  ...
  <div>
    <v-row dense class="mb-2">
      ...
      <v-col cols="12" sm="6" class="d-flex justify-end ga-2 align-start">
        <v-btn color="info" variant="outlined" prepend-icon="mdi-file-delimited-outline" @click="exportReport('csv')">{{
          t('reports.exportCsv')
        }}</v-btn>
        <v-btn color="excel" variant="outlined" prepend-icon="mdi-file-excel-outline" @click="exportReport('xlsx')">{{
